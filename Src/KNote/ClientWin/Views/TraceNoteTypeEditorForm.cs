...
public partial class TraceNoteTypeEditorForm : KntForm, IViewEditor<TraceNoteTypeDto>
{
    ...
    private void TraceNoteTypeEditorForm_FormClosing(object sender, FormClosingEventArgs e)
    {
        if (!_viewFinalized)
        {
    ...
    private void TraceNoteTypeEditorForm_KeyPress(object sender, KeyPressEventArgs e)
    {
        _formIsDisty = true;
    }

    private void TraceNoteTypeEditorForm_KeyUp(object sender, KeyEventArgs e)
    {
