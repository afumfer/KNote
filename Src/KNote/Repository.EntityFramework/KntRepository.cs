...
public class KntRepository : IKntRepository
{
    ...
    private IKntTraceNoteRepository _traceNotes;
    public IKntTraceNoteRepository TraceNotes
    {
        get
        {
            if (_traceNotes == null)
                if (_context != null)
                    _traceNotes = new KntTraceNoteRepository(Context, _repositoryRef);
                else
                    _traceNotes = new KntTraceNoteRepository(_repositoryRef);
            return _traceNotes;
        }
    }
    ...
    public IKntTraceNoteTypeRepository TraceNoteTypes
    {
        get
        {
            if (_traceNoteTypes == null)
                if (_context != null)
                    _traceNoteTypes = new KntTraceNoteTypeRepository(Context, _repositoryRef);
                else
